...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="absolute isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center sm:scale-y-[119%] lg:scale-y-[175%]">
        <motion.div
        ...
        <motion.div
          ...
          //Blue light below the blue line.
          whileInView={{
            // width:
        ...
        <motion.div
          ...
          //Blue Line on top of the tagline
          whileInView={{
            width:
              typeof window !== "undefined"
                ? window.innerWidth >= 768
      ...
      <div className="relative z-50 flex -translate-y-3 flex-col items-center px-5 sm:-translate-y-0 md:translate-y-10 xl:-translate-y-0">
        {children}
      </div>
    </div>
  );
